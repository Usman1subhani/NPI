									...
									<TableRow key={session.id} hover>
										...
										<TableCell sx={{ display: "flex", alignItems: "center", gap: "3px" }}>
											{session.status === "running" && (
												<>
													<Button variant="outlined" sx={{ width: 'fit-content',padding:'10px 10px 10px 10px',lineHeight:0 }} onClick={() => handleStop(session.id)}>
														Stop
													</Button>
													<Button variant="outlined" sx={{ width: 'fit-content',padding:'10px 10px 10px 10px',lineHeight:0 }} onClick={() => handleResume(session.id)}>
														Resume
													</Button>
												</>
											)}
